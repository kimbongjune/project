...
public class SendExample 
{
	...
	//문자 전송
	public void SendSMS(String phonenumber, String mail)
	{
		 ...
		 */
		String api_key = "NCS7VRDPY1YFZYQF";
		String api_secret = "KKREWT3Q9AJ2YJKNOTGHFZAMXAEWQ15R";
		...
		set.put("from", "01082724694"); // 발신번호
		set.put("text", "[전주에 빠지다 이메일찾기] 회원님의 이메일은 "+ mail + " 입니다."); // 문자내용
