...
<script>
	...
	function can() 
	{
		...
		window.location='jj_list.jsp?k=<%=k%>&boardtype=<%=type%>&page=<%=pages%>&no=<%= no %>';
	}
					...
					<div style="width:100%; padding:12px; display: inline-block; vertical-align: middle; margin-bottom: 50px;">
						...
						<div id="addrdiv" style="float: left; width:50%">
							<span style="font-size:18pt; padding:12px;">
								...
								<input type="text" id="addres" name="addres" size="40%" style="height:23px;" readonly value="<%= bvo.getAddress() %>">
						...
						<div id="numberdiv" style="float: left; width:50%">
							<span style="font-size:18pt;">
								...
								<input type="text" id="number" name="number" size="40%" style="height:23px;" value="<%= bvo.getNumber() %>">
								<br>
