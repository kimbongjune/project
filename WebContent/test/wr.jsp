...
<script>
	...
	function can() 
	{
		...
		/* 보드타입이 무엇? 수정해야함 */
		window.location='jj_list.jsp?k=<%=k%>&boardtype=<%=type%>&page=<%=pages%>';
	}
		...
		<div id="main_bg">
			...
			<div style="width:100%;">
				<form id="writeFrm" name="writeFrm" method="post" action="../Write.do" enctype="multipart/form-data">
					...
					<div style="width:100%; padding:12px; display: inline-block; vertical-align: middle;">
						<p style="margin-bottom:20px; margin-top:20px; border:solid 1px;"></p>
					...
					<!-- 첨부파일 버튼 영역 -->
					<div style="width:100%; padding:12px; display: inline-block;">
						<p style="margin-bottom:20px; border:solid 1px;"></p>
					...
					<!-- 미리보기 이미지 실행영역  -->
					<div class="img_wrap" style="position: relative; display: flex; width:100%; align-items: baseline; justify-content: space-evenly; margin-bottom:50px;">		
						<div class="img_wrap">
							<img id="img1" />
						</div>
						<div class="img_wrap">
